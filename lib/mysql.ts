...
function createPool(): Pool {
  ...
  // MYSQL_AUTH_20260715 is read once, verbatim, and passed straight to
  ...
  // DB_PASSWORD, DB_PASSWORD_V2, MYSQL_PASSWORD_20260715, or any other
  // variable.
  const password = process.env.MYSQL_AUTH_20260715;

  if (!host || !database || !user || !password) {
    throw new Error(
      "MySQL connection is not configured (missing DB_HOST/DB_NAME/DB_USER/MYSQL_AUTH_20260715)."
    );
  }
